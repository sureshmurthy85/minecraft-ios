n stage('Build') {
   ...
   stage('Publish'){
	    cloudBeesFlowPublishArtifact artifactName: 'com.demo:helloworld', artifactVersion: 'release-1.0-${BUILD_NUMBER}-SNAPSHOT', configuration: 'flow-server-latest', filePath: 'target/minecraft-ios-1.0-SNAPSHOT.jar', repositoryName: 'default'
   }
