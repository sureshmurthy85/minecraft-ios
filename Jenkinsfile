node {
   ...
   stage('Publish'){
        cloudBeesFlowCallRestApi body: '', configuration: 'flow-server', envVarNameForResult: '', httpMethod: 'DELETE', urlPath: '/artifacts/com.demo:helloworld'
	      cloudBeesFlowPublishArtifact artifactName: 'com.demo:helloworld', artifactVersion: '1.0-SNAPSHOT', configuration: 'flow-server', filePath: 'target/helloworld-1.0-SNAPSHOT.jar', repositoryName: 'default'
   }
   stage('Results') {
